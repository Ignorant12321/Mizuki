...
export const zh_CN: Translation = {
	...
	[Key.collection]: "荟萃",
	[Key.collectionSubtitle]: "常用工具收集",
	[Key.collectionSearchPlaceholder]: "搜索工具名称或描述...",
	[Key.collectionNewsTitle]: "时语",
	[Key.collectionNewsDescription]: "聚合 RSS 资讯源，快速浏览实时新闻",
	...
	[Key.newsSources]: "订阅源",
	[Key.newsEmpty]: "暂时没有获取到新闻内容",
	[Key.newsEmptyDescription]: "可以稍后重试，或者检查 RSS 地址是否可访问。",
	[Key.newsExpand]: "展开",
	[Key.newsCollapse]: "收起",
	[Key.newsLoadMore]: "加载更多新闻",
	...
	[Key.musicPlayerPlaylistSource]: "切换歌单",
	[Key.musicPlayerSongSource]: "切换歌曲",
	[Key.musicPlayerLyrics]: "歌词",
	[Key.musicPlayerLyricsLoading]: "歌词加载中...",
	[Key.musicPlayerLyricsEmpty]: "暂无歌词",
	[Key.musicPlayerLoading]: "加载中...",
	[Key.musicPlayerErrorPlaylist]: "播放列表获取失败",
	[Key.musicPlayerErrorNoPlaylists]: "没有可用的歌单",
	...
	[Key.projectsSearchPlaceholder]: "搜索项目名称、描述或技术栈...",
