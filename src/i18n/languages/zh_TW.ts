...
export const zh_TW: Translation = {
	...
	[Key.friendsTags]: "標籤",
	[Key.navigation]: "導航",
	[Key.navigationSubtitle]: "發現並整理常用網站",
	[Key.navigationSearchPlaceholder]: "搜索網站名稱或描述...",
	[Key.navigationFilterAll]: "全部",
	[Key.navigationVisit]: "訪問",
	[Key.collection]: "薈萃",
	[Key.collectionSubtitle]: "常用工具收集",
	[Key.collectionSearchPlaceholder]: "搜尋工具名稱或描述...",
	[Key.collectionNewsTitle]: "新聞",
	[Key.collectionNewsDescription]: "聚合 RSS 資訊源，快速瀏覽即時消息",
	...
	[Key.newsSource]: "來源",
	[Key.newsSourceDescription]: "聯合早報即時",
	[Key.newsSources]: "訂閱源",
	[Key.newsEmpty]: "暫時沒有獲取到新聞內容",
	...
	[Key.musicPlayerPlaylistSource]: "切換歌單",
	[Key.musicPlayerSongSource]: "切換歌曲",
	[Key.musicPlayerLyrics]: "歌詞",
	[Key.musicPlayerLyricsLoading]: "歌詞載入中...",
	[Key.musicPlayerLyricsEmpty]: "暫無歌詞",
	[Key.musicPlayerLoading]: "載入中...",
	[Key.musicPlayerErrorPlaylist]: "播放列表獲取失敗",
	[Key.musicPlayerErrorNoPlaylists]: "沒有可用的歌單",
