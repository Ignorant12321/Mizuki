...
export const ja: Translation = {
	...
	[Key.navigationSubtitle]: "よく使うサイトをまとめて探す",
	...
	[Key.musicPlayerPlaylistSource]: "プレイリストを切り替え",
	[Key.musicPlayerLoading]: "読み込み中...",
	[Key.musicPlayerErrorPlaylist]: "プレイリストを取得できませんでした。",
	[Key.musicPlayerErrorNoPlaylists]: "利用可能なプレイリストがありません。",
	...
	[Key.displaySettingsEffects]: "効果スイッチ",
	[Key.enableLive2d]: "Live2D",
	[Key.enableClickEffect]: "クリック効果",
	[Key.enableWaves]: "波紋効果",
	[Key.enableSakura]: "桜エフェクト",
	[Key.enableWallpaperCarousel]: "壁紙カルーセル",
	[Key.displaySettingsArticleLayout]: "記事レイアウト",
	[Key.layoutList]: "リスト",
	[Key.layoutGrid]: "グリッド",
	[Key.displaySettingsResetAll]: "デフォルトに戻す",
	[Key.displaySettingsResetSection]: "このセクションをリセット",
